...
export const MainCard = () => {
  ...
  const [timeExec, setTimeExec] = useState<number>(0.0);
  ...
  const firstClickHandler = useCallback(() => {
    ...
    const {pointsResult, time} =
    method === "dnc"
    ? drawBezierCurve(newBezierProps)
    : drawBezierCurveBruteForce(newBezierProps);
    ...
    const datas: LineSvgProps = {
      data: [
        ...
        //{
        //  id: 'Constructline'
        //  data: getConstructionLine(newBezierProps);
        //}
      ],
    };
    setProps(datas);
  ...
  return (
    <Card className="w-full h-full flex flex-col items-center justify-start bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-40 border border-gray-500 overflow-hidden">
      <CardHeader className="w-[95%] h-[15%]">
        <CardTitle className="font-extrabold text-4xl text-gray-100">
          Tucil 2 STIMA
        </CardTitle>
        <CardDescription className="text-gray-200 ml-1">
          Bezier Curve
        </CardDescription>
        ...
        >
          ...
          <TabsContent value="dnc">
                                          ...
                                          <FormField
                                            ...
                                            render={({ field }) => (
                                              <FormItem className="flex flex-row justify-center items-center gap-5">
                                                <FormLabel className="h-full flex text-center font-semibold justify-center items-center mt-[8px]">
                                                  X:
                                                </FormLabel>
                                                <FormControl>
                                                  <Input
            ...
            <Card className="h-auto w-auto mt-5">
              <CardContent className="h-auto w-auto p-5 flex flex-row items-center justify-center">
                ...
                <div className="flex flex-row gap-2 h-full w-full justify-center items-center select-none">
                  ...
                  <div className="w-fit px-2 h-[30px] bg-[#1d1d1d] rounded-sm flex justify-center items-center">
                    <h1 className="text-white text-center font-bold">
                      {timeExec}
                    </h1>
                  </div>
